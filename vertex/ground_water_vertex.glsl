...
void main() {
    ...
    fragPos = ftransform();
	LightVec = vec3(gl_ModelViewMatrixInverse*gl_LightSource[0].position);
	...
	//WorldToTangent = mat3(normalize(WorldTangent), normalize(WorldBinormal), normalize(WorldNormal));
